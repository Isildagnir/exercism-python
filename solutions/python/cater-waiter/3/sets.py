...
def categorize_dish(dish_name, dish_ingredients):
    ...
    list_category = [(VEGAN, 'VEGAN'), (VEGETARIAN, 'VEGETARIAN'), (PALEO, 'PALEO'), (KETO, 'KETO'), (OMNIVORE, 'OMNIVORE')]
...
def compile_ingredients(dishes):
    ...
    return compiled_ingredients.union(*dishes)
...
def singleton_ingredients(dishes, intersection):
    ...
    for item in dishes:
        singleton_ingredients_set = singleton_ingredients_set.union(set(item).difference(intersection))
