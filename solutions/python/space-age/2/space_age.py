"Class with functions to calculate how old someone would be on a planet in our solar system"

class SpaceAge:
    "Class representing the age depending of the planet in our solar system"
